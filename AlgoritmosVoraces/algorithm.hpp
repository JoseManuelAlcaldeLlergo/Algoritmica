...
class Algorithm
{
	private:
		...
		//The position corresponding to the Digital Curve, los puntos que componen la aproximacion poligonal
		...
		//Matrix for calculate summations, sumatorios para acelerar el calculo de los errores
	...
	public:
		...
		//This function is used to obtain the polygonal approximation IMPORTANTE
