...
class DigitalCurve
{
	...
	public:
		...
		//Return the length of the digital curve (No se usa en la practica)
		...
		//Calculate the maximum error between two points of the curve and its position (No se usa en la practica)
